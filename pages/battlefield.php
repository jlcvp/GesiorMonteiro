...
if(!defined('INITIALIZED'))
	exit;
$main_content .= '
<center><img src="http://www.tibiawiki.com.br/images/7/74/Majestic_Shield.gif"><h2><b>BATTLEFIELD</b></h2></center>
</center>
...
Battlefield é um evento automático que ocorre: <b>Sexta-feira, Sabado e Domingo às 20:00hrs</b>.</span><br>
		</td>
	</tr>
	<tr bgcolor="#d4c0a1"><td width="35%">
O sistema irá balancear os times automaticamente.<br>
		</td>
	</tr>
	<td colspan="3" bgcolor="#f1e0c6"><span class="style4">
São formados por dois times, os "Black Warriors" e os "Red Warriors";</span>
		</td>
	<tr bgcolor="#d4c0a1"><td width="35%">
...
Quando passar os 10 minutos de espera o teleport fechará e o tempo para as pedras sumir será de 2 minutos.</span><br>
	...
	<tr bgcolor="#d4c0a1"><td width="35%">O Portal fica ao lado esquerdo do templo.<br>
		</td>
	</tr>
	<td colspan="3" bgcolor="#f1e0c6"><span class="style4">
O sistema tem por finalidade matar todos do time inimigo, e os participantes que sobreviverem do time vencedor receberá a recompensa.</span><br>
	...
	<tr bgcolor="#d4c0a1"><td width="35%">
<b>Restrições:</b> Somente pode partircipar jogadores de nivel 80 ou superior, ao morrer no evente não perde (skill, level ou loot).</td>
	</tr>
	<td colspan="3" bgcolor="#f1e0c6"><span class="style4"> <b>Recompensa</b>: 500k de xp, 200k de gold coins.</b>.</i></span><br>
		</td>
</tbody>
</table>
</center>
