...
if(!$logged)
	...
	else
	{
				...
				case Visitor::LOGINSTATE_NO_ACCOUNT:
					...
					<div class="MessageContainer" >
						...
						<div class="ErrorMessage" >
							...
							<br/>Account with that name doesnt exist.<br/>
		</div>
						<div class="BoxFrameHorizontal" style="background-image:url(./layouts/tibiacom/images/content/box-frame-horizontal.gif);" /></div>
						<div class="BoxFrameEdgeRightBottom" style="background-image:url(./layouts/tibiacom/images/content/box-frame-edge.gif);" /></div>
						<div class="BoxFrameEdgeLeftBottom" style="background-image:url(./layouts/tibiacom/images/content/box-frame-edge.gif);" />
					</div>
							</div>
									</div>
		...
		$main_content .= '	<form action="?subtopic=accountmanagement" method="post" style="margin: 0px; padding: 0px;">
															...
															<tr>
																<td>
																	<table style="float: left; width: 370px;" cellpadding="0" cellspacing="0" >
																		<tr>
																			<td class="LabelV120" ><span><span><b>Account Name:</b></span></span></td>
																			<td><input type="password" name="account_login" size="35" maxlength="30" ></td>
																		</tr>
																		<tr>
																			<td class="LabelV120" ><span><span><b>Password:</b></span></span></td>
																			<td><input type="password" name="password_login" size="35" maxlength="29" ></td>
																		</tr>
																	</table>
																	<div style="float: right; font-size: 1px;" >
																		<input type="hidden" name="page" value="overview" >
																			<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton.gif)" ><div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="Login" alt="Login" src="./layouts/tibiacom/images/buttons/_sbutton_login.gif" >
																				</div>
																			</div>
																		</form>
																		...
																		<form action="?subtopic=lostaccount" method="post" style="padding:0px;margin:0px;" >
																			<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton.gif)" ><div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="Account lost?" alt="Account lost?" src="./layouts/tibiacom/images/buttons/_sbutton_accountlost.gif" >
																				</div>
																			</div>
																		</form>
																	</div>
		...
		<center>
					<h1>New to ' . htmlspecialchars($config['server']['serverName']) . '?</h1>
				</center>
				<div class="TableContainer" >
					<table class="Table4" cellpadding="0" cellspacing="0" >
						<div class="CaptionContainer" >
																...
																<td >
																	<div style="float: right; margin-top: 20px;" >
																		<form class="MediumButtonForm" action="?subtopic=createaccount" method="post" >
																			<div class="MediumButtonBackground" style="background-image:url(./layouts/tibiacom/images/buttons/mediumbutton.gif)" onMouseOver="MouseOverMediumButton(this);" onMouseOut="MouseOutMediumButton(this);" ><div class="MediumButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/mediumbutton-over.gif)" onMouseOver="MouseOverMediumButton(this);" onMouseOut="MouseOutMediumButton(this);" ></div>
																				<input class="MediumButtonText" type="image" name="Create Account" alt="Create Account" src="./layouts/tibiacom/images/buttons/mediumbutton_joinnow.png" />
																			</div>
																		</form>
																	</div>
																	<div id="LoginCreateAccountBox" >
																		<p><b>' . htmlspecialchars($config['server']['serverName']) . '...</b></p>
...
else
{
	if($action == "")
	{
		...
		if($account_logged->getCustomField('premdays') > 0)
			$account_status = '<span class="green">Premium Account</span>';
		else
			$account_status = '<span class="red">Free Account</span>';
		if($account_logged->getCustomField('premdays') > 0)
																...
																<tbody>
																	<tr>
																		...
																		<td width="100%" valign="middle">
																			<span class="BigBoldText">'.$account_status.'</span>';
																		$main_content .= '
																			<small><br>Your premium time expires at <font style="text-transform:capitalize;">'.date('d/m/Y, H:i:s', $account_logged->getCustomField('premdays')).'</font></small>
																			<small><br>
																				(Balance of Tibia Coins: <font class="red">'.$account_logged->getCoins() .'</font> Coins)
																			</small>';
																		...
																		<td>
																			<form action="?subtopic=accountmanagement&action=manage" method="post" style="padding:0px;margin:0px;">
																				<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton.gif)">
																					<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_over.gif);">
																						</div>
																						<input class="ButtonText" type="image" name="Manage Account" alt="Manage Account" src="./layouts/tibiacom/images/buttons/_sbutton_manageaccount.gif">
																					</div>
																				</div>
																			</form>
																			<div style="font-size:1px;height:4px;"></div>
																				<form action="?subtopic=buypoints" method="post" style="padding:0px;margin:0px;">
																					<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_green.gif)">
																						<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_green_over.gif);"></div>
																							<input class="ButtonText" type="image" name="Get Coins" alt="Get Coins" src="./layouts/tibiacom/images/buttons/_sbutton_gettibiacoins.gif">
																						</div>
																					</div>
																				</form>
																				<div style="font-size:1px;height:4px;"></div>
																				<form action="?subtopic=accountmanagement&action=logout" method="post" style="padding:0px;margin:0px;">
																					<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_red.gif)">
																						<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton_red_over.gif);"></div>
																							<input class="ButtonText" type="image" name="Logout" alt="Logout" src="./layouts/tibiacom/images/buttons/_sbutton_logout.gif">
																						</div>
																					</div>
																				</form>
																			</td>
											...
											<form action="?subtopic=accountmanagement&action=registeraccount" method="post" style="padding:0px;margin:0px;" >
												<div class="BigButton" style="background-image:url(./layouts/tibiacom/images/buttons/sbutton.gif)" >
													<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" >
														...
														<input class="ButtonText" type="image" name="Register Account" alt="Register Account" src="./layouts/tibiacom/images/buttons/_sbutton_registeraccount.gif">
													</div>
												</div>
											</form>
											<div style="font-size:1px;height:4px;" ></div>
