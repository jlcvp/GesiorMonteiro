...
if($page > 0)
	$main_content .= '<TR><TD WIDTH=100% ALIGN=right VALIGN=bottom><A HREF="?subtopic=highscoresrook&list='.urlencode($list).'&page='.($page - 1).'&vocation=' . urlencode($vocation) . '" CLASS="size_xxs">Previous Page</A></TD></TR>';
if($page < 50)
	$main_content .= '<TR><TD WIDTH=100% ALIGN=right VALIGN=bottom><A HREF="?subtopic=highscoresrook&list='.urlencode($list).'&page='.($page + 1).'&vocation=' . urlencode($vocation) . '" CLASS="size_xxs">Next Page</A></TD></TR>';
$main_content .= '</TABLE></TD><TD WIDTH=5%></TD><TD WIDTH=15% VALIGN=top ALIGN=right><TABLE BORDER=0 CELLPADDING=4 CELLSPACING=1><TR BGCOLOR="'.$config['site']['vdarkborder'].'"><TD CLASS=whites><B>Choose a skill</B></TD></TR><TR BGCOLOR="'.$config['site']['lightborder'].'"><TD><A HREF="?subtopic=highscoresrook&list=experience" CLASS="size_xs">Experience</A><BR><A HREF="?subtopic=highscoresrook&list=magic" CLASS="size_xs">Magic</A><BR><A HREF="?subtopic=highscoresrook&list=shield" CLASS="size_xs">Shielding</A><BR><A HREF="?subtopic=highscoresrook&list=distance" CLASS="size_xs">Distance</A><BR><A HREF="?subtopic=highscoresrook&list=club" CLASS="size_xs">Club</A><BR><A HREF="?subtopic=highscoresrook&list=sword" CLASS="size_xs">Sword</A><BR><A HREF="?subtopic=highscoresrook&list=axe" CLASS="size_xs">Axe</A><BR><A HREF="?subtopic=highscoresrook&list=fist" CLASS="size_xs">Fist</A><BR><A HREF="?subtopic=highscoresrook&list=fishing" CLASS="size_xs">Fishing</A><BR></TD></TR></TABLE></TD><TD></TD></TR></TABLE>';